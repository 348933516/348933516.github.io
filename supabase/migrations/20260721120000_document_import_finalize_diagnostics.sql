-- Keep large document imports atomic while surfacing the exact transaction
-- stage that failed. Existing media IDs may be retried safely for the same
-- content after a network or client interruption.
