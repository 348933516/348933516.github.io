  ...
  const uploadInlineImages = async (files: File[]) => {
    ...
    try {
      for (const [index, file] of files.entries()) {
        ...
        uploaded.push({ src: publicAssetUrl(path), alt: name, caption: name });
      }
